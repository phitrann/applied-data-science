...
NUMBER_PAGES_LOADING = 4        # setup the number of pages (there are 50 jobs/page load)
CURRENT_PAGE = 1                # the value for loop counter
PATH_URL = 'https://www.vietnamworks.com/viec-lam?q=it&g=5&page='
SORTED_REQUEST = '&sorting=lasted'
START_URL = PATH_URL + str(CURRENT_PAGE) + SORTED_REQUEST
...
def get_next_page_url():
    return PATH_URL + str(CURRENT_PAGE) + SORTED_REQUEST
